...
library SqrtPriceMath8x {
        ...
        returns (uint160)
    {
        ...
        unchecked {
            ...
            uint256 numerator1 = uint256(liquidity) << FixedPoint968x.RESOLUTION;
            ...
            if (add) {
                ...
                return uint160(UnsafeMath8x.divRoundingUp(numerator1, (numerator1 / sqrtPX96).add(amount)));
            } else {
                uint256 product;
