        ...
        checkHappy(
            bytes(
                string.concat(
                    ...
                    "min-amount-in-wbtc-weth: uniswap-v3-quote-exact-output(wbtc weth 1 [uniswap-v3-fee-low]),"
                    "min-amount-in-weth-wbtc: uniswap-v3-quote-exact-output(weth wbtc 1e-10 [uniswap-v3-fee-low]);"
                )
            ),
            expectedStack,
        ...
        checkBadInputs(
            bytes(
                string.concat(
                    ...
                    "wbtc: 0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599,",
                    "weth: 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2,",
                    "_: uniswap-v3-quote-exact-output(wbtc weth 1e18 0xdeadbeef 1);"
                )
            ),
            7,
            4,
        ...
        checkBadOutputs(
            bytes(
                string.concat(
                    ...
                    "wbtc: 0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599,",
                    "weth: 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2,",
                    ": uniswap-v3-quote-exact-output(wbtc weth 1 [uniswap-v3-fee-low]);"
                )
            ),
            6,
            1,
        ...
        checkBadOutputs(
            bytes(
                string.concat(
                    ...
                    "wbtc: 0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599,",
                    "weth: 0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2,",
                    "_ _: uniswap-v3-quote-exact-output(wbtc weth 1 [uniswap-v3-fee-low]);"
                )
            ),
            6,
            1,
